...
**************************************************************************************************/
#ifndef STACK_VECTORBASED_H
#define STACK_VECTORBASED_H
...
class Stack
{
    ...
    private:
        Vector<DATA> container_; // Underlying container that data will be held in
};
